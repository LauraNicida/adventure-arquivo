// JogoArquivo.js
import { EngineMenu } from "./EngineMenu.js";
import {
  Recepcao, Corredor, SalaClimatizacao, Deposito, Catalogacao, ArquivoCentral
} from "./SalasArquivo.js";

export class JogoArquivo extends EngineMenu {
  constructor(){
    super();
    this.estado = {
      usaLuvas:false,
